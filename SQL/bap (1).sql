...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2024 at 02:10 AM
...
INSERT INTO `account` (`account_id`, `id_number`, `email`, `password`) VALUES
(10, 'ADMIN00001', 'nmarcjacob@gmail.com', '$2y$10$d3sV54t6PXwv2vBnPYQ5huxLblJvgWUx8PiETsainAFUQAMYIpzbe');

-- --------------------------------------------------------

--
-- Table structure for table `account-role`
--
...
--
-- Indexes for table `account-role`
--
...
--
-- Constraints for table `account-role`
--
ALTER TABLE `account-role`
